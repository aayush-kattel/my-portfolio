        ...
        {allSkills.length > 0 && (
          <>
            ...
            <div>
              ...
              <div style={s.tags}>
                {allSkills.map((sk, i) => <span key={i} style={s.tag}>{sk}</span>)}
              </div>
            </div>
          </>
        )}
        {allTools.length > 0 && (
          <>
            ...
            <div>
              ...
              <div style={s.tags}>
                {allTools.map((sk, i) => <span key={i} style={s.tag}>{sk}</span>)}
              </div>
            </div>
          </>
        )}
      ...
      <div style={s.main}>
        <div style={s.hero}>
          ...
          <div style={s.heroName}>
            {firstName} <span style={s.heroSpan}>{lastName}</span>
          </div>
        </div>
        ...
        <div style={s.secs}>
          ...
          {data.profile && (
            <div>
              <div style={s.secLbl}>
                <span style={s.secNum}>01</span>
                <span style={s.secTitle}>Profile</span>
                <div style={s.secLine}/>
              </div>
          ...
          {allEdu.length > 0 && (
            <div>
              <div style={s.secLbl}>
                <span style={s.secNum}>02</span>
                <span style={s.secTitle}>Education</span>
                <div style={s.secLine}/>
              </div>
              <div style={s.eduList}>
                {allEdu.map((e, i) => (
                  <div key={i} style={s.eduItem}>
                    <div style={s.eduDc}>
                      <div style={s.eduDot}/>
                      {i < allEdu.length - 1 && <div style={s.eduLn}/>}
                    </div>
                    <div>
          ...
          {allProj.length > 0 && (
            <div>
              <div style={s.secLbl}>
                <span style={s.secNum}>03</span>
                <span style={s.secTitle}>Projects</span>
                <div style={s.secLine}/>
              </div>
          ...
          <div>
            <div style={s.secLbl}>
              ...
              <span style={s.secTitle}>Experience</span>
              <div style={s.secLine}/>
            </div>
            {hasExp ? (
              ...
              <div style={s.eduList}>
                {allExp.map((e, i) => (
                  <div key={i} style={s.eduItem}>
                    <div style={s.eduDc}>
                      <div style={s.eduDot}/>
                      {i < allExp.length - 1 && <div style={s.eduLn}/>}
                    </div>
                    <div>
              ...
              <div style={s.expCard}>
                ...
                <div style={s.expDesc}>
                  {data.expFallback || "Ready to bring fresh energy, strong work ethic, and modern technical skills to a professional team. Open to full-time roles, internships, and remote opportunities."}
                </div>
              </div>
            )}
          </div>
...
function CVGeneratorPage() {
  ...
  const [data, setData] = useState({
    ...
    tools:     ["", "", "", "", ""],
    education: [
      { degree:"", school:"", year:"", desc:"" },
      { degree:"", school:"", year:"", desc:"" },
    ],
    projects: [
      { title:"", stack:"", desc:"", coming:false },
      { title:"", stack:"", desc:"", coming:false },
    ],
  ...
  const inp = {
    ...
    borderRadius:"8px", padding:"8px 11px", color:text,
    fontSize:"12.5px", fontFamily:"monospace", outline:"none",
    transition:"border .2s,box-shadow .2s", boxSizing:"border-box",
  };
  const lbl = {
    display:"block", fontSize:"10px", letterSpacing:".12em",
  ...
  const onFocus = e => {
    e.target.style.borderColor = "#5ba898";
    e.target.style.boxShadow   = "0 0 0 3px rgba(91,168,152,0.12)";
  };
  const onBlur = e => {
  ...
  const handleDownload = useCallback(async () => {
    ...
    try {
      ...
      const canvas = await html2canvas(el, {
        ...
        width: 794, height: 1123, backgroundColor: "#0f1923",
      });
      ...
      <div style={{ flex:1, overflow:"auto", padding:"22px 20px" }}>
        {step === "form" ? (
            ...
            <div>
              <RCard title="// personal_info">
                ...
                <div style={{ ...fg, textAlign:"center" }}>
                  ...
                  <label
                    onClick={() => photoRef.current?.click()}
                    style={{ cursor:"pointer", fontSize:"10px", color:"#5ba898", fontFamily:"monospace", letterSpacing:".1em", display:"inline-flex", alignItems:"center", gap:"4px" }}
                  >
                  ...
                  {photoSrc && (
                    <button
                      ...
                      style={{ display:"block", margin:"3px auto 0", background:"none", border:"none", color:"#c96a6a", fontSize:"10px", cursor:"pointer", fontFamily:"monospace" }}
                    >
                      remove
                    </button>
                  )}
                ...
                {data.education.map((e, i) => (
                  <div key={i} style={{ borderLeft:"2px solid rgba(91,168,152,0.3)", paddingLeft:"12px", marginBottom:"12px" }}>
                    <div style={{ display:"flex", justifyContent:"space-between", marginBottom:"6px" }}>
                      ...
                      {i > 0 && (
                        <button onClick={() => removeItem("education", i)} style={{ background:"none", border:"none", color:"#c96a6a", fontSize:"10px", cursor:"pointer", fontFamily:"monospace", display:"inline-flex", alignItems:"center", gap:"3px" }}>
                      ...
                      <div style={{ display:"flex", gap:"10px", alignItems:"center" }}>
                        <label style={{ display:"flex", alignItems:"center", gap:"4px", fontSize:"10px", color: p.coming ? "#d4935a" : text2, fontFamily:"monospace", cursor:"pointer", fontWeight: p.coming ? 600 : 400 }}>
                          <input
                            type="checkbox"
                            checked={!!p.coming}
                            onChange={e => setArrObj("projects", i, "coming", e.target.checked)}
                            style={{ accentColor:"#d4935a" }}
                          />
                          {p.coming ? "✓ coming soon" : "coming soon"}
                        </label>
                        {i > 0 && (
                          <button onClick={() => removeItem("projects", i)} style={{ background:"none", border:"none", color:"#c96a6a", fontSize:"10px", cursor:"pointer", fontFamily:"monospace", display:"inline-flex", alignItems:"center", gap:"3px" }}>
                            <FaTrash size={9}/> remove
                          </button>
                        )}
                      </div>
              ...
              <RCard title="// experience">
                ...
                {data.experience.map((e, i) => (
                  <div key={i} style={{ borderLeft:"2px solid rgba(91,168,152,0.3)", paddingLeft:"12px", marginBottom:"12px" }}>
                    <div style={{ display:"flex", justifyContent:"space-between", marginBottom:"6px" }}>
                      ...
                      {i > 0 && (
                        <button onClick={() => removeItem("experience", i)} style={{ background:"none", border:"none", color:"#c96a6a", fontSize:"10px", cursor:"pointer", fontFamily:"monospace", display:"inline-flex", alignItems:"center", gap:"3px" }}>
                          <FaTrash size={9}/> remove
                        </button>
                      )}
                    </div>
                ...
                <div style={{ borderTop:`1px solid ${T("rgba(26,18,8,0.07)","rgba(255,255,255,0.07)")}`, paddingTop:"12px", marginTop:"4px" }}>
                  ...
                  <div style={{ marginBottom:"8px" }}>
                    ...
                    <input style={inp} value={data.expFallbackTitle} onChange={e => setField("expFallbackTitle", e.target.value)} placeholder="Actively Seeking First Professional Role" onFocus={onFocus} onBlur={onBlur}/>
                  </div>
                  <div>
                    <label style={lbl}>Fallback Description</label>
                    <textarea style={{ ...inp, height:"60px", resize:"vertical" }} value={data.expFallback} onChange={e => setField("expFallback", e.target.value)} placeholder="e.g. Ready to bring fresh energy and strong work ethic…" onFocus={onFocus} onBlur={onBlur}/>
                  </div>
                </div>
          ...
          <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:"14px" }}>
            <div style={{ fontSize:"11px", color:text2, fontFamily:"monospace", display:"flex", alignItems:"center", gap:"12px", flexWrap:"wrap", justifyContent:"center" }}>
...
export default function UserDemandPage() {
  ...
  /* ── sudo close -userdemand — IGNORES inputs/textareas ── */
  ...
  return (
    <div
      ref={sectionRef}
      style={{ minHeight:"100vh", background:t("#f0e8d8","#18191a"), display:"flex", position:"relative", overflow:"hidden", transition:"background 0.6s" }}
    >
