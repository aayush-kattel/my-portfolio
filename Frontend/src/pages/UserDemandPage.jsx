...
function CVPreview({ data, cvTheme, photoSrc }) {
  ...
  const s = {
    ...
    /* MAIN — always dark, explicitly set on every node */
    main:      { background:"#162030", display:"flex", flexDirection:"column" },
    hero:      { padding:"18px 28px 12px", borderBottom:`1px solid ${t.muted}`, flexShrink:0, background:"#162030" },
    ...
    secs:      { padding:"11px 28px 0", display:"flex", flexDirection:"column", gap:"10px", flex:1, overflow:"hidden", background:"#162030" },
    ...
    foot:      { padding:"6px 28px", borderTop:`1px solid ${t.muted}`, display:"flex", justifyContent:"space-between", alignItems:"center", flexShrink:0, background:"#162030" },
