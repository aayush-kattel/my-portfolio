...
function MessagesPage() {
  ...
  // Responsive: show message list only or split view based on screen size and selection state
    ...
    <div>
      ...
      <div style={{ 
        ...
        {isMobile && selected && (
          ...
          >
            <FaXmark /> Back to list
          </Btn>
        )}
      </div>

      {loading ? (
        <div style={{ color: "#5ba898", fontFamily: "monospace", fontSize: "13px" }}>
          Loading…
        </div>
      ) : messages.length === 0 ? (
        <Card>
