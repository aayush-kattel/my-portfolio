    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          borderRadius: "14px",
          border: devOpened ? "1.5px solid #a855f7" : "1.5px solid rgba(168,85,247,0.4)",
          cursor: "pointer",
          background: devOpened ? "rgba(168,85,247,0.25)" : "rgba(10,10,20,0.85)",
          color: devOpened ? "#d8b4fe" : "#a855f7",
          fontFamily: "'Fira Code','JetBrains Mono',monospace",
          fontSize: "clamp(8px, 1.5vw, 10px)",
          textAlign: "center",
          boxShadow: devOpened ? "0 0 20px rgba(168,85,247,0.5), inset 0 0 12px rgba(168,85,247,0.1)" : "0 4px 20px rgba(0,0,0,0.4)",
